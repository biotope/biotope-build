...
gulp.task('copy:dev:js', function() {
  return gulp
    .src(config.global.src + config.global.resources + '/js/**/*.js')
    .pipe(gulp.dest(config.global.dev + config.global.resources + '/js/'));
});

gulp.task('copy:dev:components:js', function() {
  return gulp
    .src(config.global.src + config.global.components + '/**/*.js')
    .pipe(
      gulp.dest(
...
gulp.task('copy:dev:npm:js', function() {
  ...
  return mergeStream(
    Object.keys(resources).map(function(key, index) {
...
gulp.task('copy:dev:npm:bower', function() {
  ...
  return mergeStream(
    Object.keys(bowerResources).map(function(key, index) {
