...
var isNumber = function (variable) {
    var value = parseInt(variable, 10);
    return value === value && typeof value === 'number';
};
var toSassVariable = function (variable) { return (!isNumber(variable) && variable[0] !== '#' ? "'" + variable + "'" : variable); };
var flattenObject = function (variables, prefix) {
    ...
    return Object.keys(variables)
        ...
        return (__assign({}, accumulator, (typeof variables[key] === 'object'
            ...
            : (_a = {}, _a["" + prefix + (prefix ? '_' : '') + key] = toSassVariable(variables[key]), _a))));
    }, {});
};
