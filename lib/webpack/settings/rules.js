...
exports.getRules = function (minify, globalStyles, enabledPlugins, compileExclusions, runtimeVariables) { return ([
    __assign({ test: /\.(j|t)sx?$/, use: {
            loader: 'babel-loader',
        ...
        : {})),
    {
        ...
        ].concat((enabledPlugins.indexOf('mini-css-extract-plugin') >= 0 ? [mini_css_extract_plugin_1.loader] : []), [
            {
                loader: 'css-loader',
                options: {
                    modules: true,
