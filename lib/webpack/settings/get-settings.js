...
exports.getSettings = function (options) {
    ...
    var style = __assign({ global: false, extract: false, prefix: '' }, (compilation.style || {}));
    ...
    var settings = {
        ...
        minify: minify,
        overrides: options.overrides || (function (c) { return c; }),
        paths: paths,
        runtime: runtime,
        compilation: {
            ...
            rules: rules_1.getRules(minify, style.global, style.extract, style.prefix, compilation.compileExclusions || [], runtime),
        },
    };
    return settings;
};
