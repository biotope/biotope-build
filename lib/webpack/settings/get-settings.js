...
exports.getSettings = function (options) {
    ...
    return {
        ...
        webpack: {
            ...
            favicons: favicons_1.getFavicons(options.webpack, paths, minify),
            output: mergeDeep({
                script: '[name].js',
                style: '[name].css',
            }, webpack.output || {}),
            ...
            rules: rules_1.getRules(minify, webpack.globalStyles || false, webpack.disablePlugins || [], webpack.compileExclusions || [], runtime),
        },
    };
};
