// THIS FILE NEEDS TO BE WRITTEN IN ES5 AS THE HELPERS ARE USED IN THE FRONTEND
const setupEnvVars = require('./env-helper');
...
module.exports = function (handlebars) {
  ...
  /**
	 * returns a string with an env variable
	 */
  handlebars.registerHelper('bioEnv', function (envVar) {
    return JSON.parse(environmentVariables[envVar]);
  });
  ...
  handlebars.registerHelper('bioInclude', function (partialName, context) {
    ...
    var partialData = deepMergeObjectsIntoNew(this, objectData, context.hash);
...
var deepMergeObjectsIntoNew = function () {
  var newObject = {};
