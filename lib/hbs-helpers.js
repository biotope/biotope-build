...
module.exports.register = function (handlebars) {
	 ...
	 * creates fill text
	 */
	handlebars.registerHelper('text', function (count, max=0) {
	    // output random count of characters between count and max
		if (max !== 0 && max > count) {
	...
	handlebars.registerHelper('include', function (partialName, context) {
		...
		const partialData = {};
		$.lodash.extend(partialData, this);
		$.lodash.extend(partialData, objectData);
		$.lodash.extend(partialData, context.hash);
