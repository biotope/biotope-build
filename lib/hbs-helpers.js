...
module.exports.register = function (handlebars) {
	 ...
	 */
	handlebars.registerHelper('bioHelperDef', function (a, b) {
		return a ? a : b;
	});
	 ...
	 * creates fill text
	 */
	handlebars.registerHelper('bioHelperText', function (count, max) {
	 ...
	 */
	handlebars.registerHelper('bioHelperCode', function (content) {
		return content.fn();
	});
	 ...
	 */
	handlebars.registerHelper('bioHelperStringify', function (object) {
	 ...
	 * stringify an json/js object for debugging
	 */
	handlebars.registerHelper('bioHelperParseJSON', function (data, options) {
	 ...
	 * include a partial
	 */
	handlebars.registerHelper('bioHelperInclude', function (partialName, context) {
		...
		if (!partial) {
			console.log(colors.red('partial not found: block helper fallback will be used'));
	 ...
	 * {{/bioHelperCompare}}
	 */
	handlebars.registerHelper('bioHelperCompare', function (left, operator, right, options) {
		/*jshint eqeqeq: false*/
		if (arguments.length < 3) {
			throw new Error('Handlebars Helper "helperCompare" needs 2 parameters');
		}
		...
		if (!operators[operator]) {
			throw new Error('Handlebars Helper "helperCompare" doesn\'t know the operator ' + operator);
		}
	 ...
	 * {{math 10 '%' 3}} returns 1
	 */
	handlebars.registerHelper("helperMath", function(lvalue, operator, rvalue, options) {
