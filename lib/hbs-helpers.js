...
module.exports.register = function (handlebars) {
	 ...
	 */
	handlebars.registerHelper('helperDef', function (a, b) {
		return a ? a : b;
	});
	 ...
	 * creates fill text
	 */
	handlebars.registerHelper('helperText', function (count, max) {
	 ...
	 */
	handlebars.registerHelper('helperCode', function (content) {
		return content.fn();
	});
	 ...
	 */
	handlebars.registerHelper('helperStringify', function (object) {
	 ...
	 * stringify an json/js object for debugging
	 */
	handlebars.registerHelper('helperParseJSON', function (data, options) {
	 ...
	 * include a partial
	 */
	handlebars.registerHelper('helperInclude', function (partialName, context) {
	 ...
	 * {{/compare}}
	 */
	handlebars.registerHelper('helperCompare', function (left, operator, right, options) {
		/*jshint eqeqeq: false*/
